...
const FAQSection = () => {
  ...
  return (
    <section className="bg-[#f9f9f9] py-32 px-6 md:px-12 lg:px-20 font-monosans">
      <div className="max-w-[1500px] mx-auto text-black">
        ...
        <div className="mb-24 border-t border-black/10 pt-12">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <div className="max-w-4xl">
              ...
              <h2 className="font-monosansnarrow mt-10 text-[14vw] md:text-[8.5rem] leading-[0.85] font-black uppercase tracking-wide">
                <ParallaxSplitText text="Quick" className="block" />
                <ParallaxSplitText text="Help" className="block opacity-50" />
              </h2>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:items-stretch">
          ...
          <div className="lg:col-span-5 h-full">
            <motion.div
              className="relative h-full w-full min-h-[500px] rounded-[2.5rem] overflow-hidden group border border-black/5"
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
                ...
                return (
                  <div key={faq.id} className="group">
                    <button
                      ...
                      className="w-full py-10 flex items-center justify-between text-left transition-colors hover:bg-black/2"
                    >
                      <div className="flex gap-8 items-start">
                        <span className="text-[16px] font-black text-black/20 mt-2 uppercase tracking-widest">
                          {faq.id}
                        </span>
                        <h3
                          className={`text-2xl md:text-3xl font-black uppercase tracking-tighter transition-all duration-500 ${
                            open ? "translate-x-4" : "text-black"
                          }`}
                        >
                          {faq.question}
                        </h3>
                      ...
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center border transition-all duration-500 ${
                          open
                            ? "bg-primary text-white border-black rotate-45"
                    ...
                    <AnimatePresence>
                      {open && (
                        ...
                        >
                          <p className="pb-10 pl-20 text-lg md:text-xl text-black/60 max-w-2xl font-medium leading-relaxed">
                            {faq.answer}
                          </p>
                        </motion.div>
                      )}
            ...
            {/* INTEGRATED CTA BOX */}
            <div className="mt-12 bg-black text-white p-12 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group/cta">
              <div className="relative z-10">
                <p className="text-[10px] uppercase tracking-[0.3em] opacity-40 mb-3 font-black">
                  Need more clarity?
                </p>
