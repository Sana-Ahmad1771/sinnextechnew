...
const ContactHero = () => {
  return (
    <main className="relative bg-[#080808] text-white font-monosans min-h-screen">
      
      {/* --- Background Abstract Elements --- */}
      <div className="fixed inset-0 pointer-events-none select-none overflow-hidden">
        <div className="absolute -left-[15%] bottom-[-20%] w-[50%] h-[120%] bg-gradient-to-tr from-primary via-[#080808] to-primary -rotate-12 opacity-40 blur-[120px] z-0"></div>
        <div className="absolute -right-[15%] -top-[30%] w-[60%] h-[130%] bg-gradient-to-bl from-primary via-[#080808] to-primary rotate-[15deg] opacity-40 blur-[120px] z-0"></div>
      </div>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6 items-start lg:items-end mb-16 md:mb-24">
          ...
          <div className="w-full lg:col-span-4 border-l border-white/10 pl-6">
            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest leading-relaxed max-w-xs">
              Directing digital evolution through <span className="text-white">strategic</span> design.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              <div className="group border-b border-white/5 pb-6">
                <p className="text-[9px] uppercase tracking-[0.3em] text-white/40 mb-3">Email</p>
                <a href="mailto:hello@agency.com" className="text-xl md:text-3xl font-monosansnarrow uppercase font-bold flex items-center justify-between hover:text-primary transition-colors">
                  hello@SinnexTech.com
                  <FiArrowUpRight className="group-hover:rotate-45 transition-transform duration-300" />
                </a>
              </div>
              <div className="group border-b border-white/5 pb-6">
                <p className="text-[9px] uppercase tracking-[0.3em] text-white/40 mb-3">SOftware House</p>
          ...
          <div className="bg-white/5 backdrop-blur-3xl rounded-[2rem] p-8 md:p-12 border border-white/10 shadow-2xl">
            <form className="space-y-6 md:space-y-8">
              <div className="grid md:grid-cols-2 gap-6">
                <input type="text" placeholder="NAME" className="w-full bg-transparent border-b border-white/10 py-3 focus:outline-none focus:border-primary transition-colors text-xs uppercase tracking-widest" />
                <input type="email" placeholder="EMAIL" className="w-full bg-transparent border-b border-white/10 py-3 focus:outline-none focus:border-primary transition-colors text-xs uppercase tracking-widest" />
              </div>
              <textarea rows="3" placeholder="MESSAGE" className="w-full bg-transparent border-b border-white/10 py-3 focus:outline-none focus:border-primary transition-colors text-xs uppercase tracking-widest resize-none" />
